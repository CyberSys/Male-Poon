...
# MOZ_APP_VERSION_DISPLAY is not used in Male Poon so set it
# to MOZ_APP_VERSION
...
MOZ_BRANDING_DIRECTORY=malepoon/branding/unofficial
MOZ_OFFICIAL_BRANDING_DIRECTORY=malepoon/branding/official

# Enables conditional code in the platform for Male Poon only
MC_PALEMOON=1
...
# XXX: Devtools are disabled until they can be made to work with Male Poon
MOZ_DEVTOOLS=1
